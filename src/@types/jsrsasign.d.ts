declare namespace jsrsasign {
  ...
  class ASN1HEX {
    ...
    static getVbyList(h: string, currentIndex: number, nhList: any[], checkingTag?: string, removeUnusedbits?: boolean): string | null;

    static getVbyListEx(h: string, currentIndex: number, nhList: any[], checkingTag?: string, removeUnusedbits?: boolean): string | null;
